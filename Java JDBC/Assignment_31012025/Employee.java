...
import Assignment_31012025.IdAlreadyExistsException;
import Assignment_31012025.IdNotFoundException;
import Assignment_31012025.IncorrectChoiceException;
import Assignment_31012025.InvalidAgeException;
import Assignment_31012025.InvalidIdException;
...
class Employee {
    ...
    Employee(String name, int age, String designation, String department, double salary) {
        this.name = name;
        this.age = age;
    ...
    protected static Employee getEmployee(int type, String name, int age, int department, double salary,
            DatabaseHandler handler) {
        Employee emp = new Employee(name, age, EmployeeType.employeeTypes.get(type - 1),
                EmployeeDepartment.employeeDepartments.get(department - 1), salary);
        int id = handler.insertEmployee(emp);
        emp.id = id;
        return emp;
    }
